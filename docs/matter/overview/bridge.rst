...
In addition to the core part, the |NCS| also includes an example `Matter bridge sample <Matter bridge sample>`_ application that you can use as a reference for creating your own application.
