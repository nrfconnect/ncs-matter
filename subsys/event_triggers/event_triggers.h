...
public:
	...
	*/
	...
	constexpr static TriggerSlot kMaxEventTriggers = CONFIG_MATTER_TEST_EVENT_TRIGGERS_MAX;
	constexpr static TriggerSlot kInvalidTriggerSlot = CONFIG_MATTER_TEST_EVENT_TRIGGERS_MAX + 1;
