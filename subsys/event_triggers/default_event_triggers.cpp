...
#ifdef CONFIG_MATTER_DIAGNOSTIC_LOGS_TEST
 ...
 * must receive the acknowledgment from the device.  */
enum class DelayedAction {
	FactoryReset,
#ifdef CONFIG_MATTER_WATCHDOG_EVENT_TRIGGERS
	BlockMainThread,
#endif
};
struct DelayedCtx {
...
#ifdef CONFIG_MATTER_DIAGNOSTIC_LOGS_CRASH_LOGS
...
#endif /* CONFIG_MATTER_DIAGNOSTIC_LOGS_CRASH_LOGS */
#endif /* CONFIG_MATTER_DIAGNOSTIC_LOGS_TEST */
