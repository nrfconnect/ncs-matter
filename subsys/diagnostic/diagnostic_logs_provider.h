...
#if defined(CONFIG_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS) ||                                                 \
	defined(CONFIG_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS)
...
#if defined(CONFIG_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS) &&                                                  \
	defined(CONFIG_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS)
