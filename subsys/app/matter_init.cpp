...
#ifdef CONFIG_MATTER_DIAGNOSTIC_LOGS
...
#ifdef CONFIG_MATTER_TEST_EVENT_TRIGGERS_REGISTER_DEFAULTS
#include "event_triggers/default_event_triggers.h"
#endif
#endif

#ifdef CONFIG_MATTER_WATCHDOG_DEFAULT
#include "app/task_executor.h"
#include "watchdog/watchdog.h"
#endif

#ifdef CONFIG_MATTER_TEST_SHELL
...
void DoInitChipServer(intptr_t /* unused */)
{
	...
	if (ConfigurationMgr().GetRebootCount(count) == CHIP_NO_ERROR) {
		...
		TEMPORARY_RETURN_IGNORED Nrf::Matter::DiagnosticLogProvider::GetInstance().Init();
	}
#endif
...
#endif /* CONFIG_MATTER_TEST_EVENT_TRIGGERS_REGISTER_DEFAULTS */
#endif /* CONFIG_MATTER_TEST_EVENT_TRIGGERS */
#else
...
/* Set KMUKeyAllocator for devices that supports KMU */
	...
	static Nrf::Watchdog::WatchdogSource sAppWatchdog(CONFIG_MATTER_WATCHDOG_DEFAULT_FEED_TIME, FeedFromApp);
	static Nrf::Watchdog::WatchdogSource sMatterWatchdog(CONFIG_MATTER_WATCHDOG_DEFAULT_FEED_TIME, FeedFromMatter);
