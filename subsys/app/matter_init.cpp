...
/* Set KMUKeyAllocator for devices that supports KMU */
	...
	static Nrf::Watchdog::WatchdogSource sAppWatchdog(CONFIG_MATTER_WATCHDOG_DEFAULT_FEED_TIME,
							  FeedFromApp);
	static Nrf::Watchdog::WatchdogSource sMatterWatchdog(CONFIG_MATTER_WATCHDOG_DEFAULT_FEED_TIME,
							     FeedFromMatter);
