...
# Generate Twister options for the ncs-matter add-on based on modified files.
...
repository_path = _ADDON_ROOT
repo_to_scan = Repo(_ADDON_ROOT)
args = None
...
def parse_args():
    ...
    parser.add_argument('-t', '--tests_per_builder', default=200, type=int,
            help="Number of tests per builder")
    parser.add_argument('-n', '--default-matrix', default=4, type=int,
            help="Default matrix")
    parser.add_argument('--testcase-roots-threshold', default=15, type=int,
    ...
    parser.add_argument('-r', '--repo-to-scan', default=str(_ADDON_ROOT),
            help="Matter add-on repository root")
    ...
    parser.add_argument('--alt-tags',
            default=str(_CI_DIR / 'tags.yaml'),
            help="Path to a file describing relations between directories and tags")
    parser.add_argument(
            "-T", "--testsuite-root", action="append",
            default=[str(_ADDON_ROOT / "samples")],
    ...
    parser.add_argument(
            ...
            default=[str(_ADDON_ROOT / "scripts" / "quarantine.yaml")],
